...
input_test: input_test.c input.c board.c logic.c score.c output.c gui.c minesweeper.h
	gcc -o input_test --coverage input_test.c input.c board.c logic.c score.c output.c gui.c -lm -lgtk-3 $(FLAG1) $(FLAG2)
