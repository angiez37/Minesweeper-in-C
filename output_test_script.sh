...
test './output_test' 'output_test_input1.txt' 'output_test_output1.txt' 'logic_test_empty.txt'
test './output_test' 'output_test_input2.txt' 'output_test_output2.txt' 'logic_test_empty.txt'
